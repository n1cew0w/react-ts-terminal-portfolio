                            ...
                            <input className={styles.input}
                                   ...
                                   onKeyDown={event => {
                                       if (event.key === "Enter") {
                                           ...
                                           switch (input) {
                                               case "help":
                                                   newOutput = <Typewriter cursor={false} speed={50} text={"Все команды: " + commands}/>
                                                   console.log(newOutput)
                                                   break;
                                               case 'github':
                                                   newOutput = <Typewriter cursor={false} speed={150} text={'Переход на мой github аккаунт....' } onFinished={github}/>
                                                   console.log(newOutput)
                                                   break;
                                               case 'vk':
                                                   newOutput = <Typewriter cursor={false} speed={150} text={'Переход на мой аккаунт vk....' } onFinished={vk}/>
                                                   console.log(newOutput)
                                                   break;
                                                   case 'tg':
                                                   newOutput = <Typewriter cursor={false} speed={150} text={'Переход на мой telegram аккаунт....' } onFinished={tg}/>
                                                   console.log(newOutput)
                                                   break;
                                               case 'clear':
                                                   newOutput = ''
                                                   newOutput = <Typewriter cursor={false} speed={150} text={"Терминал очищен "}/>
                                                   console.log(newOutput)
                                                   break;
                                               default:
                                                   // newOutput = <Typewriter speed={150} text={"Этой команды не существует "}/>
                                           }
                                           // @ts-ignore
                                           setOutput(newOutput)
                                           setInput('')
